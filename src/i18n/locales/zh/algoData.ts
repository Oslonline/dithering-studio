const algoData = {
  algoData: {
    ...
    28: {
      overview: '将图像减少到特定数量的色调级别，以获得大胆的图形海报效果。',
      characteristics: { 0: '可调级别（2-16）', 1: '大胆的图形', 2: '色带' },
      artifacts: { 0: '明显的色调步进', 1: '失去平滑渐变' },
      bestFor: { 0: '海报艺术', 1: '平面设计', 2: '复古美学' },
      neighborhood: '每像素',
      notes: {
        0: '阈值控制级别数量（0-255 映射到 2-16 级别）',
        1: '较低阈值 = 更少级别 = 更多海报化',
        2: '与有限的调色板配合使用效果很好',
      },
    },
    29: {
      overview: '高对比度边缘增强抖动，模仿传统木刻/油毡印刷。',
      characteristics: { 0: '边缘增强', 1: '高对比度', 2: '印刷风格' },
      artifacts: { 0: '强烈的轮廓', 1: '二元色调', 2: '失去中间色调' },
      bestFor: { 0: '艺术效果', 1: '大胆的图形', 2: '传统印刷外观' },
      neighborhood: '3×3 Sobel',
      notes: {
        0: '使用 Sobel 边缘检测来强调轮廓',
        1: '最好使用双色调色板以获得真实的木刻效果',
        2: '阈值控制边缘强调和对比度',
      },
    },
    30: {
      overview: '基于密度的点放置，创建类似传统钢笔和墨水绘画的点画/雕刻效果。',
      characteristics: { 0: '基于点的渲染', 1: '密度变化', 2: '类似绘画' },
      artifacts: { 0: '颗粒状纹理', 1: '在明亮区域稀疏', 2: '非确定性' },
      bestFor: { 0: '雕刻效果', 1: '艺术插图', 2: '钢笔和墨水风格' },
      neighborhood: '独立点',
      notes: {
        0: '较暗区域接收更多点画点',
        1: '阈值控制整体点密度',
