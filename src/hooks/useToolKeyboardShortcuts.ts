 ...
 */
export function useToolKeyboardShortcuts({ images, activeImageId, setActiveImageId, setFocusMode, setShowGrid, setGridSize }: Params) {
  useEffect(() => {
  ...
  }, [images, activeImageId, setActiveImageId, setFocusMode, setShowGrid, setGridSize]);
}
