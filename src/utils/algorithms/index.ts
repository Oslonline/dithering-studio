...
const registry: AlgorithmMeta[] = [
  ...
  { id: 12, name: 'Sierra Lite', category: 'Error Diffusion', supportsThreshold: true, orderKey: 'error:sierra-lite:4', run: (ctx) => runSierraLite(ctx) },
  { id: 4, name: 'Burkes', category: 'Error Diffusion', supportsThreshold: true, orderKey: 'error:burkes:5', run: (ctx) => runBurkes(ctx) },
  { id: 5, name: 'Stucki', category: 'Error Diffusion', supportsThreshold: true, orderKey: 'error:stucki:6', run: (ctx) => runStucki(ctx) },
  { id: 6, name: 'Sierra', category: 'Error Diffusion', supportsThreshold: true, orderKey: 'error:sierra:7', run: (ctx) => runSierra(ctx) },
  { id: 7, name: 'Jarvis–Judice–Ninke', category: 'Error Diffusion', supportsThreshold: true, orderKey: 'error:jjn:8', run: (ctx) => runJJN(ctx) },
  { id: 13, name: 'Two-Row Sierra', category: 'Error Diffusion', supportsThreshold: true, orderKey: 'error:two-row-sierra:9', run: (ctx) => runTwoRowSierra(ctx) },
  { id: 14, name: 'Stevenson–Arce', category: 'Error Diffusion', supportsThreshold: true, orderKey: 'error:stevenson-arce:10', run: (ctx) => runStevensonArce(ctx) },
  ...
  { id: 21, name: 'Adaptive FS 3×3', category: 'Error Diffusion', supportsThreshold: true, supportsPalette: true, orderKey: 'error:afs3:12', run: (ctx) => runAdaptiveFS3(ctx) },
  { id: 22, name: 'Adaptive FS 7×7', category: 'Error Diffusion', supportsThreshold: true, supportsPalette: true, orderKey: 'error:afs7:13', run: (ctx) => runAdaptiveFS7(ctx) },
